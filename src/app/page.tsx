  ...
  return (
    <main className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-md mx-auto">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">FitCompete</h1>
        <p className="text-sm text-gray-500 mb-6">Scoring en vivo para competencias de CrossFit</p>
